...
public class Face
{
    ...
    public GameObject mObject { set; get; }
    ...
    {
        var aX = VarRect.width == 0 ? 0 : Mathf.Clamp((p.x - VarRect.xMin) / VarRect.width, 0, 1);
        var aY = VarRect.height == 0 ? 0 : Mathf.Clamp((p.y - VarRect.yMin) / VarRect.height, 0, 1);
